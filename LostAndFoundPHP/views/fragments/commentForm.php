<div class="editor bg-white text-gray-800 mx-auto w-full flex flex-col 
    ...
    <form hx-post="/addComment" id="commentForm" hx-target="#commentFormModal">
        <input type="hidden" name="id" id="itemToComment" value="<?=$_POST['id']??''?>">
        <h2 class=" text-center font-bold text-2xl text-gray-800 p-4">Enter Comment</h2>
        ...
        <textarea data-te-input-showcounter="true" id="text"
            ...
            maxlength="255" placeholder="Enter Your Comment" name="comment"></textarea>
        <div class="buttons flex ml-auto py-2">
            <button onclick="closeCommentForm()" type="button"
