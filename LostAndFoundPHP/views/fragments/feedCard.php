<?php if (isset($postList)): ?>
    ...
    <!-- News Feed -->
    <div class="container px-6 mx-auto mb-6 grid w-full">
        <div class="grid gap-2 h-auto md:grid-cols-2 xl:grid-cols-3  hover:cursor-pointer">
            <!--Start of Cards-->
            <?php foreach ($postList as $post): ?>
                <div class="grid col-span-2">
                    <div class="flex items-center h-auto shadow-xl p-6 bg-gray-100  dark:bg-gray-800">
                        <div>
                            ...
                            <p class="text-sm font-light p-2 text-gray-700 dark:text-gray-200 ">
                                <?= $post['itemDescription'] ?? '' ?>
                            </p>
                        </div>
                        <?Php if ($_SESSION['userRole'] === 'admin' && $_GET['type'] === 'found'): ?>
                ...
                <div
                    ...
                    <div class="">
                        <img width="190" height="190" class="rounded-lg ml-6 postImg" src="./assets/img/registerbg.png" alt="gf" />
